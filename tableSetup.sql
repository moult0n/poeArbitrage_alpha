...
insert into component (name,query,fullSet) values ('A Dab of Ink','{"query":{"status":{"option":"online"},"type":"A Dab of Ink","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',9); 
insert into component (name,query,fullSet) values ('The Poet''s Pen','{"query":{"status":{"option":"online"},"name":"The Poet''s Pen","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('A Dab of Ink to The Poet''s Pen Flip',86,87,2);
insert into component (name,query,fullSet) values ('The Conduit','{"query":{"status":{"option":"online"},"type":"The Conduit","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',9); 
insert into component (name,query,fullSet) values ('Doryani''s Fist','{"query":{"status":{"option":"online"},"name":"Doryani''s Fist","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Conduit to Doryani''s Fist Flip',88,89,2);
insert into component (name,query,fullSet) values ('Audacity','{"query":{"status":{"option":"online"},"type":"Audacity","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',5);  
insert into flip (name,componentId1,componentId2,sets) values ('Audacity to Doryani''s Fist Flip',90,89,2);
insert into component (name,query,fullSet) values ('Forbidden Power','{"query":{"status":{"option":"online"},"type":"Forbidden Power","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',4); 
insert into component (name,query,fullSet) values ('Balefire','{"query":{"status":{"option":"online"},"name":"Balefire","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Conduit to Doryani''s Fist Flip',91,92,2);
insert into component (name,query,fullSet) values ('The Forsaken','{"query":{"status":{"option":"online"},"type":"The Forsaken","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',7); 
insert into component (name,query,fullSet) values ('Umbilicus Immortalis','{"query":{"status":{"option":"online"},"name":"Umbilicus Immortalis","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Forsaken to Umbilicus Immortalis',93,94,2);
insert into component (name,query,fullSet) values ('The Oath','{"query":{"status":{"option":"online"},"type":"The Oath","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',6); 
insert into component (name,query,fullSet) values ('Death''s Oath','{"query":{"status":{"option":"online"},"name":"Death''s Oath","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Oath to Death''s Oath',95,96,2);
insert into component (name,query,fullSet) values ('The Sun','{"query":{"status":{"option":"online"},"type":"The Sun","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',7); 
insert into component (name,query,fullSet) values ('Rise of the Phoenix','{"query":{"status":{"option":"online"},"name":"Rise of the Phoenix","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Sun to Rise of the Phoenix',97,98,2);
insert into component (name,query,fullSet) values ('The Watcher','{"query":{"status":{"option":"online"},"type":"The Watcher","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',12); 
insert into component (name,query,fullSet) values ('Crown of Eyes','{"query":{"status":{"option":"online"},"name":"Crown of Eyes","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Watcher to Crown of Eyes',99,100,2);
insert into component (name,query,fullSet) values ('Tranquillity','{"query":{"status":{"option":"online"},"type":"Tranquillity","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',7); 
insert into component (name,query,fullSet) values ('Voltaxic Rift','{"query":{"status":{"option":"online"},"name":"Voltaxic Rift","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('Tranquility to Voltaxic Rift',101,102,2);
insert into component (name,query,fullSet) values ('Anarchy''s Price','{"query":{"status":{"option":"online"},"type":"Anarchy''s Price","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',12); 
insert into flip (name,componentId1,componentId2,sets) values ('Anarchy''s Price to Voltaxic Rift',103,102,2);
insert into component (name,query,fullSet) values ('The Lich','{"query":{"status":{"option":"online"},"type":"The Lich","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',12); 
insert into component (name,query,fullSet) values ('Midnight Bargain','{"query":{"status":{"option":"online"},"name":"Midnight Bargain","filters":{"trade_filters":{"filters":{"sale_type":{"option":"priced"}}}}},"sort":{"price":"asc"}}',1); 
insert into flip (name,componentId1,componentId2,sets) values ('The Lich to Midnight Bargain',104,105,2);